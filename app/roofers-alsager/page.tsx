...
export default function RoofersAlsagerPage() {
  return (
    <AreaPageTemplate
      ...
      roofingChallenges="Alsager's position on the south-east edge of Cheshire means properties face weather from both the Cheshire Plain and the higher ground to the east. The older housing stock around the town centre often features concrete interlocking tiles from the 1960s-80s that are now reaching the end of their serviceable life. We regularly advise Alsager homeowners on the best time to replace ageing roofs before they develop costly problems — and can match or upgrade materials to suit both budget and property character."
      faqs={[
