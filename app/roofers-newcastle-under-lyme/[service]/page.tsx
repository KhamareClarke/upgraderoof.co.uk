...
export async function generateMetadata({ params }: { params: { service: string } }): Promise<Metadata> {
  return generateServiceLocationMetadata('newcastle-under-lyme', params.service);
}
...
export default function Page({ params }: { params: { service: string } }) {
  ...
  if (!service) notFound();
  return <ServiceLocationTemplate service={service} town={townData['newcastle-under-lyme']} />;
}