...
export const metadata: Metadata = {
  title: 'Roofers Congleton | Local Roofing Company | Upgrade Roofs',
  description: 'Trusted roofers in Congleton, Cheshire. Roof repairs, new roofs, flat roofing, emergency call-outs. CORC certified, £10M insured, 25+ years experience. Free quotes.',
  openGraph: {
