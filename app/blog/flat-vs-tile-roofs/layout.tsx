...
export const metadata: Metadata = {
  title: 'Flat vs Tile Roofs | Which is Best? | Upgrade Roofing Cheshire',
  ...
  openGraph: {
    ...
    url: 'https://upgraderoof.co.uk/blog/flat-vs-tile-roofs',
  ...
  twitter: {
    ...
    title: 'Flat vs Tile Roofs | Upgrade Roofing',
    description: 'Expert comparison of flat roofs vs tile roofs.',
  },
  alternates: {
    canonical: 'https://upgraderoof.co.uk/blog/flat-vs-tile-roofs',
  },
  robots: {
    index: true,
    follow: true,
