...
export default function OfferAlsagerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-special-offer', {
        ...
        body: JSON.stringify({ ...formData, location: 'Alsager' }),
      });
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-8 md:pt-12">
        <div className="absolute inset-0">
          <Image
            src="/images/6.jpeg"
            alt="Professional roof inspection Alsager"
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-white space-y-4">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-orange text-white font-bold animate-pulse">
                ...
                <span className="text-lg">LIMITED TIME OFFER ALSAGER</span>
              </div>
              
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  <span className="text-brand-orange">CALL NOW</span><br />
                  for Your FREE Roof Inspection in Alsager!
                </h1>
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-white/80">
                  Serving Alsager & Surrounding Areas
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-2xl">
                ...
                <p className="text-center text-gray-700 italic font-medium mb-2">
                  "Complete gutter and fascia replacement. Courteous team and outstanding results."
                </p>
                <p className="text-center text-sm text-gray-600 font-semibold">– Lisa P., Alsager</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-6">
              Got a Leak or Need a New Roof in Alsager? We Identify the Problem Fast.
            </h2>
            <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
              Whether it's a small leak or a full roof replacement, our Alsager team provides a detailed condition report 
              and a no-obligation repair plan tailored for your home. We've been trusted by Alsager families for years.
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-12 bg-gradient-to-r from-red-600 to-brand-orange text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg mb-6">
            Only 5 free inspections left this week for Alsager. Offer ends Sunday
          </p>
      ...
      <section className="section-padding bg-gradient-to-r from-brand-navy to-brand-navy/90 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Get Your Alsager Roof Checked for Free?
          </h2>
      ...
      <LocalAreaContent
        ...
        postcode="ST7"
        population="12,000"
        description="Alsager is a pleasant town straddling the Cheshire-Staffordshire border, home to Manchester Metropolitan University's Crewe campus. The town offers a mix of Victorian properties near the station, inter-war housing, and modern developments. Our Alsager roofing team provides expert services for all property types in this growing community."
        neighborhoods={[
          'Alsager Town Centre',
          'Oakhanger',
          'Linley',
        ...
        roofingChallenges={[
          'Victorian station-area properties with original slate roofs',
          'Inter-war semi-detached homes with aging tile roofs',
          'Modern estates requiring routine maintenance',
          'Rural properties exposed to weather from open farmland',
          'University area properties needing regular upkeep',
        ]}
        commonRoofTypes={[
          'Welsh slate roofs',
      ...
      <section className="py-8 bg-brand-grey border-t">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm">
            ...
            <span className="text-gray-400">·</span>
            <Link href="/offer-alsager" className="text-brand-orange font-semibold">Alsager</Link>
            <span className="text-gray-400">·</span>
