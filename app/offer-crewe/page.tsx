...
export default function OfferCrewePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-special-offer', {
        ...
        body: JSON.stringify({ ...formData, location: 'Crewe' }),
      });
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-8 md:pt-12">
        <div className="absolute inset-0">
          <Image
            src="/images/6.jpeg"
            alt="Professional roof inspection Crewe"
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-white space-y-4">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-orange text-white font-bold animate-pulse">
                ...
                <span className="text-lg">LIMITED TIME OFFER CREWE</span>
              </div>
              
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  <span className="text-brand-orange">CALL NOW</span><br />
                  for Your FREE Roof Inspection in Crewe!
                </h1>
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-white/80">
                  Serving Crewe & Surrounding Areas
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-2xl">
                ...
                <p className="text-center text-gray-700 italic font-medium mb-2">
                  "Superb workmanship on our flat roof conversion. The Crewe team were punctual and left everything spotless."
                </p>
                <p className="text-center text-sm text-gray-600 font-semibold">– Mark D., Crewe</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-6">
              Got a Leak or Need a New Roof in Crewe? We Identify the Problem Fast.
            </h2>
            <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
              Whether it's a small leak or a full roof replacement, our Crewe team provides a detailed condition report 
              and a no-obligation repair plan tailored for your home. We've been the trusted roofers for Crewe residents for over 25 years.
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-12 bg-gradient-to-r from-red-600 to-brand-orange text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg mb-6">
            Only 5 free inspections left this week for Crewe. Offer ends Sunday
          </p>
      ...
      <section className="section-padding bg-gradient-to-r from-brand-navy to-brand-navy/90 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Get Your Crewe Roof Checked for Free?
          </h2>
      ...
      <LocalAreaContent
        ...
        postcode="CW1, CW2"
        population="85,000"
        description="Crewe is a major railway town in Cheshire East with a rich industrial heritage. The town has diverse housing stock ranging from Victorian railway workers' cottages to large post-war estates and modern developments. Our Crewe roofing team understands the unique challenges of the area's varied architecture and provides expert services across all property types."
        neighborhoods={[
          'Crewe Town Centre',
          'Wistaston',
          'Shavington',
        ...
        roofingChallenges={[
          'Victorian terraced houses with original slate roofs requiring specialist repair',
          'Post-war council housing with aging concrete tile roofs',
          'Industrial pollution legacy affecting roof materials',
          'Flat roofs on 1960s-80s properties needing replacement',
          'Large detached properties with complex roof structures',
        ]}
        commonRoofTypes={[
          'Welsh slate (Victorian properties)',
          'Concrete Marley tiles',
          'Redland interlocking tiles',
          'Flat felt roofs',
          'EPDM rubber roofing',
      ...
      <section className="py-8 bg-brand-grey border-t">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm">
            ...
            <Link href="/offer-crewe" className="text-brand-orange font-semibold">Crewe</Link>
            <span className="text-gray-400">·</span>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "url": "https://upgraderoof.co.uk/offer-crewe",
        "areaServed": "Crewe"
      })}} />
    </div>
  );
