...
export default function OfferMiddlewichPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-special-offer', {
        ...
        body: JSON.stringify({ ...formData, location: 'Middlewich' }),
      });
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-8 md:pt-12">
        <div className="absolute inset-0">
          <Image
            src="/images/6.jpeg"
            alt="Professional roof inspection Middlewich"
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-white space-y-4">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-orange text-white font-bold animate-pulse">
                ...
                <span className="text-lg">LIMITED TIME OFFER MIDDLEWICH</span>
              </div>
              
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  <span className="text-brand-orange">CALL NOW</span><br />
                  for Your FREE Roof Inspection in Middlewich!
                </h1>
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-white/80">
                  Serving Middlewich & Surrounding Areas
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-2xl">
                ...
                <p className="text-center text-gray-700 italic font-medium mb-2">
                  "Prompt response and quality repair work on our leaking roof. Highly recommend to anyone in Middlewich."
                </p>
                <p className="text-center text-sm text-gray-600 font-semibold">– John R., Middlewich</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-6">
              Got a Leak or Need a New Roof in Middlewich? We Identify the Problem Fast.
            </h2>
            <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
              Whether it's a small leak or a full roof replacement, our Middlewich team provides a detailed condition report 
              and a no-obligation repair plan tailored for your home. We understand the unique roofing needs of Middlewich properties.
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-12 bg-gradient-to-r from-red-600 to-brand-orange text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg mb-6">
            Only 5 free inspections left this week for Middlewich. Offer ends Sunday
          </p>
      ...
      <section className="section-padding bg-gradient-to-r from-brand-navy to-brand-navy/90 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Get Your Middlewich Roof Checked for Free?
          </h2>
      ...
      <LocalAreaContent
        ...
        postcode="CW10"
        population="13,500"
        description="Middlewich is a historic salt town on the Trent and Mersey Canal in Cheshire. Known for its Roman heritage and annual Folk & Boat Festival, the town features charming period properties alongside modern developments. As your local Middlewich roofers, we're based just minutes away and provide rapid response for all roofing needs."
        neighborhoods={[
        ...
        roofingChallenges={[
          'Historic canal-side properties with heritage roofing requirements',
          'Salt subsidence affecting roof structures in older areas',
          'Period cottages requiring traditional materials and techniques',
          'Modern estates with standard tile roofs needing maintenance',
          'Exposed rural properties vulnerable to wind damage',
        ]}
        commonRoofTypes={[
          ...
          'Lead work on period properties',
        ]}
        nearbyAreas={[
      ...
      <section className="py-8 bg-brand-grey border-t">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm">
            ...
            <span className="text-gray-400">·</span>
            <Link href="/offer-middlewich" className="text-brand-orange font-semibold">Middlewich</Link>
            <span className="text-gray-400">·</span>
