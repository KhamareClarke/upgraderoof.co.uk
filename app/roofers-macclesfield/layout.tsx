...
export const metadata: Metadata = {
  ...
  description: 'Local roofers in Macclesfield (SK10). CORC certified, £10M insured, 10-year guarantee. Flat roofing, tiles, chimney repairs, gutters, skylights & cladding. Free quotes.',
