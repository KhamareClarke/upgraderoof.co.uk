...
export default function OfferCongletonPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-special-offer', {
        ...
        body: JSON.stringify({ ...formData, location: 'Congleton' }),
      });
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-8 md:pt-12">
        <div className="absolute inset-0">
          <Image
            src="/images/6.jpeg"
            alt="Professional roof inspection Congleton"
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-white space-y-4">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-orange text-white font-bold animate-pulse">
                ...
                <span className="text-lg">LIMITED TIME OFFER CONGLETON</span>
              </div>
              
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  <span className="text-brand-orange">CALL NOW</span><br />
                  for Your FREE Roof Inspection in Congleton!
                </h1>
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-white/80">
                  Serving Congleton & Surrounding Areas
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-2xl">
                ...
                <p className="text-center text-gray-700 italic font-medium mb-2">
                  "Fantastic job on our chimney repairs. The team were knowledgeable and completed the work ahead of schedule."
                </p>
                <p className="text-center text-sm text-gray-600 font-semibold">– Emma W., Congleton</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-6">
              Got a Leak or Need a New Roof in Congleton? We Identify the Problem Fast.
            </h2>
            <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
              Whether it's a small leak or a full roof replacement, our Congleton team provides a detailed condition report 
              and a no-obligation repair plan tailored for your home. We've been trusted by Congleton homeowners for decades.
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-12 bg-gradient-to-r from-red-600 to-brand-orange text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg mb-6">
            Only 5 free inspections left this week for Congleton. Offer ends Sunday
          </p>
      ...
      <section className="section-padding bg-gradient-to-r from-brand-navy to-brand-navy/90 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Get Your Congleton Roof Checked for Free?
          </h2>
      ...
      <LocalAreaContent
        ...
        postcode="CW12"
        population="27,000"
        description="Congleton is a historic market town on the edge of the Peak District, known as 'Beartown'. The town features beautiful Georgian and Victorian architecture in its centre, surrounded by diverse residential areas. Our Congleton roofing team specializes in both heritage property restoration and modern roofing solutions for the area's varied housing stock."
        neighborhoods={[
        ...
        roofingChallenges={[
          'Georgian and Victorian properties requiring period-appropriate materials',
          'Exposed hillside locations vulnerable to severe weather',
          'Stone-built properties with traditional stone slate roofs',
          'Complex roof structures on larger period homes',
          'Conservation area restrictions on roofing materials',
        ]}
        commonRoofTypes={[
          'Stone slate roofs',
          'Welsh slate',
      ...
      <section className="py-8 bg-brand-grey border-t">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm">
            ...
            <span className="text-gray-400">·</span>
            <Link href="/offer-congleton" className="text-brand-orange font-semibold">Congleton</Link>
            <span className="text-gray-400">·</span>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "url": "https://upgraderoof.co.uk/offer-congleton",
        "areaServed": "Congleton"
      })}} />
    </div>
  );
}
