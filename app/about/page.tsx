...
export const metadata: Metadata = {
  title: 'About Us | Upgrade Roofs Cheshire - 25+ Years of Excellence',
  description: 'Learn about Upgrade Roofs Cheshire. Award-winning roofing company with 25+ years experience. Fully insured, accredited team delivering premium roofing services across Cheshire.',
  keywords: 'about Upgrade Roofs, Cheshire roofing company, roofing contractors, experienced roofers, accredited roofing',
  openGraph: {
    title: 'About Upgrade Roofs Cheshire - Your Trusted Roofing Partners',
