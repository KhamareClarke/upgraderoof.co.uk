...
export default function OfferNantwichPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/send-special-offer', {
        ...
        body: JSON.stringify({ ...formData, location: 'Nantwich' }),
      });
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-8 md:pt-12">
        <div className="absolute inset-0">
          <Image
            src="/images/6.jpeg"
            alt="Professional roof inspection Nantwich"
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-white space-y-4">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-orange text-white font-bold animate-pulse">
                ...
                <span className="text-lg">LIMITED TIME OFFER NANTWICH</span>
              </div>
              
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  <span className="text-brand-orange">CALL NOW</span><br />
                  for Your FREE Roof Inspection in Nantwich!
                </h1>
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-white/80">
                  Serving Nantwich & Surrounding Areas
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-2xl">
                ...
                <p className="text-center text-gray-700 italic font-medium mb-2">
                  "Called them for an emergency leak. Same day, problem solved. Honest and reliable."
                </p>
                <p className="text-center text-sm text-gray-600 font-semibold">– James H., Nantwich</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-6">
              Got a Leak or Need a New Roof in Nantwich? We Identify the Problem Fast.
            </h2>
            <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
              Nantwich's beautiful period properties and modern homes require specialist roofing knowledge. Whether you're facing an emergency leak or planning preventative maintenance, our free inspection delivers a thorough assessment. We provide clear, honest advice with no obligation.
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-12 bg-gradient-to-r from-red-600 to-brand-orange text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg mb-6">
            Only 5 free inspections left this week for Nantwich. Offer ends Sunday
          </p>
      ...
      <section className="section-padding bg-gradient-to-r from-brand-navy to-brand-navy/90 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Get Your Nantwich Roof Checked for Free?
          </h2>
      ...
      <LocalAreaContent
        ...
        postcode="CW5"
        population="17,500"
        description="Nantwich is one of Cheshire's most historic and picturesque towns, famous for its black-and-white Tudor buildings and annual Battle of Nantwich re-enactment. The town centre is a conservation area with strict planning requirements. Our Nantwich roofing specialists have extensive experience working on heritage properties while meeting conservation standards."
        neighborhoods={[
        ...
        roofingChallenges={[
          'Listed buildings requiring heritage-approved materials',
          'Tudor and Georgian properties with complex roof structures',
          'Conservation area planning restrictions',
          'Traditional lime mortar chimney work',
          'Matching historical roofing materials for repairs',
        ]}
        commonRoofTypes={[
          'Handmade clay tiles',
          'Natural Welsh slate',
      ...
      <section className="py-8 bg-brand-grey border-t">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm">
            ...
            <span className="text-gray-400">·</span>
            <Link href="/offer-nantwich" className="text-brand-orange font-semibold">Nantwich</Link>
            <span className="text-gray-400">·</span>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "@type": "LocalBusiness",
        "name": "Upgrade Roofing Solutions - Nantwich",
