      ...
      <section className="section-padding bg-white">
        <div className="container-custom max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <h3 className="text-2xl font-bold text-brand-navy mb-4">Expert Roofing Contractors</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-brand-navy mb-4">Why Choose Upgrade Roofing?</h3>
          ...
          <div className="bg-brand-grey p-8 rounded-xl">
            <h3 className="text-2xl font-bold text-brand-navy mb-4">Our Roofing Services in Cheshire</h3>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-gray-700">
              <div>
                <h4 className="font-semibold text-brand-navy mb-2">Tile & Slate Roofing</h4>
              ...
              <div>
                <h4 className="font-semibold text-brand-navy mb-2">Flat Roofing</h4>
